...
```
توجه کنید که اگر اسم فایل css خودتون رو چیز دیگری نوشته بودید هم باید عینا همان اسم را در تگ link به کار ببرید. بخش `rel="stylesheet"` هم نمایانگر این است که نوع فایل لینک شده، استایل های css است.
...
```css
/* comment: وسط چین کردن نوشته */
text-align: center;
/* comment: چپ چین کردن نوشته */
text-align: left;
/* comment: راست چین کردن نوشته */
text-align: right;
```
